          ...
          return (
            <ul className="list-inline hstack gap-2 mb-0">
              <li className="list-inline-item edit" title="Call">
                <Button variant="link"
                  className="p-0 text-muted d-inline-block shadow-none"
                >
                  <i className="ri-phone-line fs-16"></i>
                </Button>
              </li>
              <li className="list-inline-item edit" title="Message">
                <Button variant="link" className="p-0 text-muted d-inline-block shadow-none">
              ...
              <li className="list-inline-item" title="Edit">
                <Button variant="link" className="p-0 edit-item-btn shadow-none"
              ...
              <li className="list-inline-item" title="Delete">
                <Button variant="link"
                  className="p-0 remove-item-btn shadow-none"
