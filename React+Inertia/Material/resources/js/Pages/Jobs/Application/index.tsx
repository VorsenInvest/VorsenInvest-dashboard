                      ...
                      <Modal.Body>
                        ...
                        <div className="mb-3">
                          ...
                          {validation.touched.company && validation.errors.company ? (
                            <Form.Control.Feedback type="invalid" className='d-block'>{validation.errors.company}</Form.Control.Feedback>
                          ) : null}
                        </div>
                        ...
                        <div className="mb-3">
                          ...
                          {validation.touched.designation && validation.errors.designation ? (
                            <Form.Control.Feedback type="invalid" className='d-block'>{validation.errors.designation}</Form.Control.Feedback>
                          ) : null}
                        </div>
                        ...
                        <div className="mb-3">
                          ...
                          {validation.touched.contacts && validation.errors.contacts ? (
                            <Form.Control.Feedback type="invalid" className='d-block'>{validation.errors.contacts}</Form.Control.Feedback>
                          ) : null}
                        </div>
                          ...
                          <div className="col-md-6">
                            <div>
                              ...
                              {validation.touched.status && validation.errors.status ? (
                                <Form.Control.Feedback type="invalid" className='d-block'>{validation.errors.status}</Form.Control.Feedback>
                              ) : null}
                            </div>
                          </div>
                          <div className="col-md-6">
