...
const AllTasks = () => {
  ...
  const selectLayoutProperties = createSelector(
    ...
    (layout) => ({
      ...
      error: layout.error,
      isTaskAdd: layout.isTaskAdd,
       isTaskAddFail: layout.isTaskAddFail,
       isTaskDelete: layout.isTaskDelete,
         isTaskDeleteFail: layout.isTaskDeleteFail,
       isTaskUpdate: layout.isTaskUpdate,
        isTaskUpdateFail: layout.isTaskUpdateFail,
    }));
