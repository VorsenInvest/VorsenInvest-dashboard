                        ...
                        <Col xl={4} lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <Swiper modules={[Navigation, Pagination, Autoplay]} pagination={{ clickable: true }} navigation={true} loop={true} autoplay={{ delay: 2500, disableOnInteraction: false }} className="mySwiper swiper navigation-swiper">
                                        <div className="swiper-wrapper">
