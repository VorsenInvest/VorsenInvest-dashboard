                                    ...
                                    <SwiperSlide>
                                        <Card>
                                            <CardBody>
                                                ...
                                                <h5 className="mb-0 fs-15"><Link to="#!" className="text-body">Artwork <span className="badge bg-secondary-subtle text-secondary">206</span></Link></h5>
                                            </CardBody>
                                        </Card>
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <Card>
                                            <CardBody>
                                                ...
                                                <Link to="#!" className="float-end fs-14"> View All <i className="ri-arrow-right-line align-bottom"></i></Link>
                                                <h5 className="mb-0 fs-15"><Link to="#!" className="text-body">Crypto Card <span className="badge bg-secondary-subtle text-secondary">743</span></Link></h5>
                                            </CardBody>
                                        </Card>
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <Card>
                                            <CardBody>
                                                ...
                                                <Link to="#!" className="float-end fs-14"> View All <i className="ri-arrow-right-line align-bottom"></i></Link>
                                                <h5 className="mb-0 fs-15"><Link to="#!" className="text-body">Music <span className="badge bg-secondary-subtle text-secondary">679</span></Link></h5>
                                            </CardBody>
                                        </Card>
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <Card>
                                            <CardBody>
                                                ...
                                                <Link to="#!" className="float-end fs-14"> View All <i className="ri-arrow-right-line align-bottom"></i></Link>
                                                <h5 className="mb-0 fs-15"><Link to="#!" className="text-body">Games <span className="badge bg-secondary-subtle text-secondary">341</span></Link></h5>
                                            </CardBody>
                                        </Card>
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <Card>
                                            <CardBody>
                                                ...
                                                <Link to="#!" className="float-end fs-14"> View All <i className="ri-arrow-right-line align-bottom"></i></Link>
                                                <h5 className="mb-0 fs-15"><Link to="#!" className="text-body">Photography <span className="badge bg-secondary-subtle text-secondary">1452</span></Link></h5>
                                            </CardBody>
                                        </Card>
                                    </SwiperSlide>
                                </div>
