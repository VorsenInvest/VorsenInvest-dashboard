                          ...
                          >
                            ...
                            >
                              <div className="d-flex align-items-center">
                                ...
                                {chat.badge && <div className="flex-shrink-0 ms-auto">
                                  ...
                                  <div className="user-chat-content">
                                    <div className="ctext-wrap">
                                      ...
                                      <UncontrolledDropdown className="align-self-start message-box-drop">
                                        ...
                                        <DropdownMenu>
                                          <DropdownItem href="#" className="reply-message" onClick={() => setreply(message)}>                                            <i className="ri-reply-line me-2 text-muted align-bottom"></i>
                                            Reply
                                          </DropdownItem>
                                          <DropdownItem href="#">
