                                ...
                                {marketPlacewidget.map((item, key) => (<Col lg={4} md={6} key={key}>
                                    <Card>
                                        <CardBody>
                                            ...
                                            <h5 className="mb-0 fs-15"><Link to="#!" className="text-body">{item.category} <span className="badge bg-success-subtle text-success">{item.quantity}</span></Link></h5>
                                        </CardBody>
                                    </Card>
                                </Col>))}
                            </Row>
                                ...
                                <Card className="explore-box">
                                    <CardBody>
                                        ...
                                        <div className="mt-3">
                                            ...
                                            <h6 className="fs-15 mb-0"><Link to="/apps-nft-item-details" className="text-body">{item.category}</Link></h6>
                                        </div>
                                    </CardBody>
                                </Card>
                            </Col>
