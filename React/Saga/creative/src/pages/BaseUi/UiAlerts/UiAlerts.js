                                        ...
                                        <Row>
                                            ...
                                            <Col xl={6}>
                                                ...
                                                <UncontrolledAlert color="light" className="alert-top-border">
                                                    <i className="ri-mail-line me-3 align-middle fs-16"></i><strong>Light</strong> - Top border alert
                                                </UncontrolledAlert>

                                                <h6>Dark Alert</h6>
                                                <UncontrolledAlert color="dark" className="alert-top-border mb-0">
                                                    <i className="ri-refresh-line me-3 align-middle fs-16"></i><strong>Dark</strong> - Top border alert
                                                </UncontrolledAlert>
