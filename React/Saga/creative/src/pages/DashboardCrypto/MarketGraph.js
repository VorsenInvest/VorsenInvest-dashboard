                                ...
                                <Row className="align-items-center">
                                    <Col xs={6}>
                                        <div className="d-flex flex-wrap gap-4 align-items-center">
                                            ...
                                            <p className="fw-semibold text-muted mb-0">$75.69 <span className="text-success fs-13 ms-1">+1.99%</span></p>
                                            <p className="fw-semibold text-muted mb-0">High <span className="text-body fs-13 ms-1">0.014578</span></p>
                                            <p className="fw-semibold text-muted mb-0">Low <span className="text-body fs-13 ms-1">0.0175489</span></p>
                                        </div>
                                    </Col>
                                    <Col xs={6}>
