            ...
            <Card className={"card-animate " + item.bgColor}>
              <CardBody>
                <div className="d-flex justify-content-between">
                  <div>
                    <p className={"fw-semibold mb-0 text-" + item.labelClass}>
                      {item.label}
                    </p>
                    <h2
                      className={
                        "mt-4 ff-secondary fw-bold " + item.counterClass
                      }
                    >
                  ...
                  <div>
                    <div className="avatar-sm flex-shrink-0">
                      <span
                        className={"avatar-title rounded-circle fs-2 bg-" + item.iconClass}
                      >
                        <FeatherIcon
                          icon={item.feaIcon}
