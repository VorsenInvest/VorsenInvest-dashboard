                                                    ...
                                                    <tr key={key}>
                                                        ...
                                                        <td>
                                                            <div className="d-flex gap-3 justify-content-center">
                                                                <button type="button" className="btn btn-ghost-primary btn-icon btn-sm favourite-btn" onClick={(e) => FavoriteBtn(e.target)}>
                                ...
                                <div id="file-overview" className="h-100">
                                    <div className="d-flex h-100 flex-column">
                                        <div className="d-flex align-items-center pb-3 border-bottom border-bottom-dashed mb-3 gap-2">
                                            ...
                                            <div>
                                                <button type="button" className="btn btn-ghost-primary btn-icon btn-sm fs-16 Favorite-btn">
                ...
                <ModalBody>
                    ...
                    >
                        <div className="mb-4">
                            ...
                            <input type="text" className="form-control" id="foldername-input" placeholder="Enter folder name"
                                name='folderName'
                                // validate={{
                                //     required: { value: true },
                                // }}
                ...
                <ModalBody>
                    ...
                    >
                        <div className="mb-4">
                            ...
                            <input type="text" className="form-control" id="filename-input" placeholder="Enter file name"
                                name="fileName"
                                // validate={{
                                //     required: { value: true },
                                // }}
