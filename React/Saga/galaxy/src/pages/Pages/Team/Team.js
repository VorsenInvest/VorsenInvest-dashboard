                            ...
                            <Row className="g-2">
                                ...
                                <Col className="col-sm-auto ms-auto">
                                    <div className="list-grid-nav hstack gap-1">
                                        ...
                                        <Button color="secondary" id="grid-view-button" className="btn btn-soft-secondary nav-link btn-icon fs-14 active filter-button"><i className="ri-grid-fill"></i></Button>
                                        <Button color="secondary" id="list-view-button" className="btn btn-soft-secondary nav-link  btn-icon fs-14 filter-button"><i className="ri-list-unordered"></i></Button>
                                        <Dropdown
                                            isOpen={dropdownOpen}
                                                            ...
                                                            <Row>
                                                                <Col>
                                                                    <div className="flex-shrink-0 me-2">
                                                                        <button type="button" className="btn btn-light btn-icon rounded-circle btn-sm favourite-btn" onClick={(e) => FavoriteBtn(e.target)}>
                                                    ...
                                                    <Row>
                                                                    ...
                                                                    <div className="d-flex position-absolute start-0 end-0 top-0 p-3">
                                                                        ...
                                                                        <div className="flex-shrink-0">
                                                                            <div className="d-flex gap-3 align-items-center">
                                                                                ...
                                                                                <button type="button" className="btn-close btn-close-white" id="createMemberBtn-close" data-bs-dismiss="modal" onClick={() => setModal(false)} aria-label="Close"></button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <Col lg={12}>
                                                            <div className="hstack gap-2 justify-content-end">
                                                                ...
                                                                <button type="submit" className="btn btn-primary" id="addNewMember">{!isEdit ? "Add Member" : "Save"}</button>
                                                            </div>
                                                        </Col>
                                                    </Row>
                                                </Form>
                                                ...
                                                <Row>
                                                    <Col>
                                                        <div className="bookmark-icon flex-shrink-0 me-2">
                                                            <Input type="checkbox" id="Favorite13" className="bookmark-input bookmark-hide" />
                                                            <Label htmlFor="Favorite13" className="btn-star">
