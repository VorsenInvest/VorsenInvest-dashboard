    ...
    return (
        <React.Fragment>
            ...
            <div className="page-content">
                <Container fluid>
                    ...
                    <div className="chat-wrapper d-lg-flex gap-1 mx-n4 mt-n4 p-1">
                        ...
                        <div className="file-manager-content w-100 p-4 pb-0 border bg-transparent">
                            <Row className="mb-4">
            ...
            <Modal id="createTask" isOpen={modalTodo} toggle={toggle} modalClassName="zoomIn" centered tabIndex="-1">
                <ModalHeader toggle={toggle} className="p-3 bg-primary-subtle"> {!!isEdit ? "Edit Task" : "Create Task"} </ModalHeader>
                <ModalBody>
                                    ...
                                    <SimpleBar style={{ maxHeight: "141px" }}>
                                        <ul className="list-unstyled mb-0">
                                            {assignee.map((item, key) => (<li key={key}>
                                                <DropdownItem className="d-flex align-items-center" href="#" onClick={() => setAssignedTo(item)}>
