        ...
        <React.Fragment>
            ...
            <div>
                <div className="customizer-setting d-none d-md-block">
                    <div onClick={() => setOpen(!open)} className="btn-primary btn-rounded shadow-lg btn btn-icon btn-lg p-2">
                        <i className='mdi mdi-spin mdi-cog-outline fs-22'></i>
                    </div>
                </div>
                <Offcanvas isOpen={open} toggle={() => setOpen(!open)} direction="end" className="offcanvas-end border-0">
                    <OffcanvasHeader className="d-flex align-items-center bg-primary bg-gradient p-3 offcanvas-header-dark" toggle={() => setOpen(!open)}>
